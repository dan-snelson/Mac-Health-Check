...
- Current release objective: ship the official `3.0.0rc6` release (promote from `3.0.0rc6rc*` to production-ready documentation and behavior)
...
## 3.0.0rc6 Release Checklist

1. Set `VERSION.txt` to `3.0.0rc6`.
2. Ensure `CHANGELOG.md` has accurate `3.0.0rc6` final-release notes and date.
